...
class LeaveAppliedViewHelp extends StatefulWidget {
  final  int leaveDays ;
  final List<DateTime> appliedLeave;
  final reason;
  const LeaveAppliedViewHelp({
    super.key, required this.leaveDays, required this.appliedLeave, this.reason,
  });

  @override
  LeaveAppliedViewHelpState createState() => LeaveAppliedViewHelpState();
}

class LeaveAppliedViewHelpState extends State<LeaveAppliedViewHelp> {

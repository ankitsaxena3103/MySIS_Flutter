...
import 'LeaveAppliedViewHelp.dart';

class SelectLeaveReasonHelp extends StatefulWidget {
final  int leaveDays ;
final List<DateTime> appliedLeave;
  const SelectLeaveReasonHelp({
...
class SelectLeaveReasonState extends State<SelectLeaveReasonHelp> {
  ...
  void onLoadLeaveApplied(){
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => LeaveAppliedViewHelp(leaveDays: widget.leaveDays, appliedLeave: widget.appliedLeave,reason: selectedReason),
      ),
    );
  }
